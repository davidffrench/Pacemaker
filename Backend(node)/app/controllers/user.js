...
exports.users = {
	...
	action: function(req, res){
		User.find(null, '-activities -friends', function(err, users) {
			if (err)
				res.send(err);
...
exports.user = {
	'spec': {
		...
		parameters : [swagger.pathParam("userId", "ID of user that needs to be fetched", "string", null, "54ada067d15f6ce862000004")],
	},
	action: function(req, res){
